...
if __name__ == "__main__":
    ...
    env = environ.StocksEnv({"TEST": prices}, bars_count=args.bars, reset_on_close=False, commission = args.commission, state_id=args.conv, random_ofs_on_reset=False, reward_on_close=False, volumes=False)
